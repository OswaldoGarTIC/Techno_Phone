...
create table ventas(
	id_vetas int(4) not null AUTO_INCREMENT primary key,
	fecha date not null,
...
create table detalle_ventas(
	id_detalle_venta int(4) not null AUTO_INCREMENT primary key,
...
create table detalle_compras(
	id_detalle_compra int(4) not null AUTO_INCREMENT primary key,
